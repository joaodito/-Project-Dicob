...
public class ControlData {
	...
	public boolean takeOutGroup(int idGroup){
		...
		return data.deleteGroup(IdGroup);
	}
	
	public boolean insertGroup(String[] dataGroup, String nameGroup, String categoryGroup){
	...
	public boolean updateGroup(String[] dataGroup, int idGroup, String nameGroup, String categoryGroup){
		Object[] atr= {idGroup, nameGroup, categoryGroup};
		if(controlObject(atr) || idGroup < 0) return false;
		Restaurant group = data.getGroup(idGroup);
		if (group == null) return false;
		group.setNameGroup(nameGroup);
		group.setCategoryGroup(categoryGroup);
		return true;
	}
	
	public boolean insertRestaurant(String[] dataRestaurant, String nameExpense, int dateExpense, String billRestaurant, double amountRestaurant){
